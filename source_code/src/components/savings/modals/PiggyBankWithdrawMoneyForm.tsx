    ...
    return (
        <div style={{
            ...
            <form onSubmit={handleSubmit} className="glass-panel" style={{ 
                ...
                <div style={{ marginBottom: '0.75rem', fontSize: '0.95rem', color: 'rgba(255,255,255,0.7)', display: 'flex', justifyContent: 'space-between' }}>
                    <span>Saldo acumulado en hucha:</span>
                    <strong style={{ color: '#ec4899' }}>{formatMoney(goal.currentAmount)}</strong>
                </div>

                <div style={{ marginBottom: '1.25rem', fontSize: '0.95rem', color: 'rgba(255,255,255,0.7)', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <div>
                    <label style={{ display: 'block', marginBottom: '0.5rem', color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>Importe a Retirar (€)</label>
                ...
                {!isNaN(parsedAmount) && parsedAmount > 0 && (
                    <div style={{ 
                        ...
                        fontSize: '0.85rem', 
                        fontWeight: 600,
                        color: parsedAmount <= goal.currentAmount ? '#10b981' : '#f43f5e' 
                    }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
                    ...
                    <button 
                        ...
                        style={{
                            ...
                            borderRadius: '12px',
                            border: 'none',
                            background: isSubmitDisabled ? 'rgba(255,255,255,0.05)' : 'linear-gradient(135deg, #ec4899, #f43f5e)',
