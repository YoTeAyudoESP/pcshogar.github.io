    ...
    return (
        <div className="glass-panel" style={{ padding: '2rem 1.5rem', height: '100%', background: 'rgba(25, 27, 34, 0.3)' }}>
            <div style={{ display: 'flex', justifyContent: 'flex-start', marginBottom: '1rem' }}>
                <h3 style={{ margin: 0, fontSize: '1.4rem', fontWeight: 700, color: 'rgba(var(--color-rgb-light), 0.8)' }}>
            ...
            <div style={{ height: '350px' }}>
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <CartesianGrid vertical={false} strokeDasharray="3 3" stroke="var(--panel-bg-2)" />
                        
                        <XAxis 
                            dataKey="name" 
                            stroke="rgba(var(--color-rgb-light),0.3)" 
                            interval={0} 
                            fontSize={12} 
                            tickLine={false}
                            axisLine={false}
                        ...
                        <Legend 
                            ...
                            height={40}
                            iconType="circle"
                            formatter={(value) => <span style={{ color: 'rgba(var(--color-rgb-light),0.7)', fontWeight: 500, marginLeft: '8px' }}>{value}</span>}
                        />
