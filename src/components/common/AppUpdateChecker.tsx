        ...
        <div style={overlayStyle}>
            ...
            <style dangerouslySetInnerHTML={{__html: `
                ...
                @keyframes downloadIconPulse {
                    0% {
                        transform: scale(1);
                        filter: drop-shadow(0 0 0px rgba(var(--color-success-rgb), 0));
                    }
                    50% {
                        transform: scale(1.05);
                        filter: drop-shadow(0 0 15px rgba(var(--color-success-rgb), 0.4));
                    }
                    100% {
                        transform: scale(1);
                        filter: drop-shadow(0 0 0px rgba(var(--color-success-rgb), 0));
            ...
            <div style={modalStyle}>
                <div style={iconContainerStyle}>
                    <ArrowDownCircle size={44} color="var(--color-success)" style={{ animation: 'downloadIconPulse 3s infinite ease-in-out' }} />
                </div>
                        ...
                        <div style={buttonContainerStyle}>
                            <button 
                                ...
                                onMouseEnter={e => {
                                    ...
                                    e.currentTarget.style.boxShadow = '0 8px 25px rgba(var(--color-success-rgb), 0.4)';
                                    e.currentTarget.style.background = 'linear-gradient(135deg, #059669 0%, #047857 100%)';
                                }}
                                onMouseLeave={e => {
                                    e.currentTarget.style.transform = 'none';
                                    e.currentTarget.style.boxShadow = '0 4px 15px rgba(var(--color-success-rgb), 0.2)';
                            ...
                            <button 
                                ...
                                onMouseEnter={e => {
                                    e.currentTarget.style.background = 'rgba(var(--color-rgb-light), 0.08)';
                                    e.currentTarget.style.borderColor = 'rgba(var(--color-rgb-light), 0.15)';
                                }}
                                onMouseLeave={e => {
...
const modalStyle: React.CSSProperties = {
    ...
    width: '100%',
    textAlign: 'center',
    boxShadow: '0 25px 50px rgba(0, 0, 0, 0.5), inset 0 1px 1px var(--panel-bg-3)',
    display: 'flex',
...
const updateButtonStyle: React.CSSProperties = {
    ...
    boxShadow: '0 4px 15px rgba(var(--color-success-rgb), 0.2)',
    width: '100%',
    outline: 'none'
};
