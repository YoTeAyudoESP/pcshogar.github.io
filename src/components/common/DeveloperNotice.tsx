    ...
    return (
        <div className="modal-overlay" style={{ zIndex: 9999, alignItems: 'center' }}>
            <div className="modal-container" style={{ maxWidth: '450px', background: '#1a1f2e', overflow: 'hidden' }}>
                <div style={{ background: bgColor, padding: '1.5rem', display: 'flex', alignItems: 'flex-start', gap: '1rem', color: 'var(--text-main)' }}>
                ...
                <div style={{ padding: '1.2rem', display: 'flex', justifyContent: 'flex-end', background: 'var(--panel-bg-1)' }}>
                    <button 
                        ...
                        onMouseEnter={e => e.currentTarget.style.background = 'rgba(var(--color-rgb-light),0.15)'}
                        onMouseLeave={e => e.currentTarget.style.background = 'var(--panel-bg-3)'}
                    >
                        <X size={16} />
                        Entendido
                    </button>
