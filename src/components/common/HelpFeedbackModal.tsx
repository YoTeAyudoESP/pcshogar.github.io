            ...
            <div className="glass-panel" style={{
                ...
                {downloading ? (
                    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center', margin: '24px 0' }}>
                        <h4 style={{ color: 'var(--text-main)', margin: 0, fontSize: '1.25rem', fontWeight: 800 }}>Descargando Actualización...</h4>
                        <p style={{ fontSize: '0.9rem', color: 'rgba(var(--color-rgb-light),0.65)', margin: 0, lineHeight: '1.5' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '32px' }}>
                            ...
                            <button
                                ...
                                onMouseEnter={e => {
                                    ...
                                    e.currentTarget.style.borderColor = 'rgba(var(--color-rgb-light),0.22)';
                                }}
                                onMouseLeave={e => {
                                    e.currentTarget.style.background = '#1e2028';
                                    e.currentTarget.style.borderColor = 'rgba(var(--color-rgb-light),0.12)';
                                }}
                            >
                                <Mail size={22} />
                ...
                <p style={{
                    fontSize: '0.78rem',
                    lineHeight: '1.4',
                    color: 'rgba(var(--color-rgb-light), 0.35)',
                    marginBottom: '24px',
                    padding: '0 10px'
                }}>
