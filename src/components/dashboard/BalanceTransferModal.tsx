        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-container glass-panel" style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
                    ...
                    <h2 style={{ fontSize: '1.5rem', fontWeight: 800, margin: 0, color: 'var(--text-main)' }}>Traspaso Rápido</h2>
                </div>
                ...
                {activeTab === 'accounts' && (
                    <div style={{
                        ...
                        <div style={{ fontSize: '0.85rem', color: 'rgba(var(--color-rgb-light),0.5)', marginBottom: '0.25rem' }}>
                ...
                {activeTab === 'savings' && (
                    <div style={{
                        ...
                        <div style={{ fontSize: '2rem', fontWeight: 900, color: availableToSpend >= 0 ? 'var(--color-success)' : '#f43f5e' }}>
                        ...
                        transferItems.map(item => (
                            <div key={item.id} style={{
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    <span style={{ fontSize: '0.7rem', color: 'rgba(var(--color-rgb-light),0.4)', textTransform: 'uppercase' }}>
                                        {item.type === 'bank' ? 'Banco' : item.type === 'cash' ? 'Efectivo' : 'Tarjeta Monedero'}
                                    </span>
                                </div>
                                <span style={{ 
                                    fontWeight: 700, 
                                    color: item.type === 'virtual' ? 'var(--color-success)' : '#38bdf8', 
                                    fontSize: '0.95rem' 
                                }}>
                        ...
                        savings.map(goal => (
                            <div key={goal.id} style={{
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    <span style={{ fontSize: '0.7rem', color: 'rgba(var(--color-rgb-light),0.4)' }}>
                                        Hucha virtual
                                    </span>
                                </div>
                                <span style={{ 
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                    ...
                    {activeTab === 'savings' && !isNaN(parsedAmount) && parsedAmount > 0 && (
                        <div style={{ 
                            ...
                            fontSize: '0.85rem', 
                            fontWeight: 600,
                            color: remaining >= 0 ? 'var(--color-success)' : '#f43f5e' 
                        }}>
                            {remaining >= 0 
                    ...
                    {activeTab === 'withdraw' && !isNaN(parsedAmount) && parsedAmount > 0 && (
                        <div style={{ 
                            ...
                            fontSize: '0.85rem', 
                            fontWeight: 600,
                            color: selectedWithdrawGoal && parsedAmount <= selectedWithdrawGoal.currentAmount ? 'var(--color-success)' : '#f43f5e' 
                        }}>
                    ...
                    {activeTab === 'accounts' ? (
                        <>
                            ...
                            <div style={{
                                ...
                                <span style={{ fontSize: '0.78rem', color: 'rgba(var(--color-rgb-light),0.6)', lineHeight: '1.4' }}>
                        ...
                        <div style={{
                            ...
                            <Info size={16} style={{ color: 'var(--color-success)', marginTop: '2px', flexShrink: 0 }} />
                            <span style={{ fontSize: '0.78rem', color: 'rgba(var(--color-rgb-light),0.6)', lineHeight: '1.4' }}>
                        ...
                        style={{
                            ...
                            boxShadow: isSubmitDisabled
                                ...
                                : activeTab === 'accounts'
                                    ...
                                    : activeTab === 'savings'
                                        ? '0 4px 15px rgba(var(--color-success-rgb), 0.3)'
