...
const Dashboard: React.FC = () => {
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: isMobile ? '0.5rem 12px' : '1rem', paddingBottom: '5rem', overflowX: 'hidden' }}>
            ...
            {showChangelog && (
                <div className="modal-overlay" onClick={() => {
                    localStorage.setItem('pcshogar_last_version', '1.2.1');
                    setShowChangelog(false);
                }}>
                    <div className="modal-container glass-panel" style={{ padding: '2.5rem 2rem', maxWidth: '460px', width: '95%', textAlign: 'center', position: 'relative' }} onClick={e => e.stopPropagation()}>
                        ...
                        <div style={{ 
                            ...
                            <div>
                                <strong style={{ color: '#38bdf8' }}>📊 Ahorro en Disponible:</strong>
                                <div style={{ color: 'rgba(255,255,255,0.6)', marginLeft: '1.2rem', fontSize: '0.82rem' }}>
                                    Corregido el disponible mensual para restar los ahorros mensuales planificados de las huchas, sin importar su estado de presupuesto principal.
                                </div>
                            </div>
                            <div>
                                <strong style={{ color: '#10b981' }}>📅 Meses Presupuestarios:</strong>
                                <div style={{ color: 'rgba(255,255,255,0.6)', marginLeft: '1.2rem', fontSize: '0.82rem' }}>
                                    Las asignaciones automáticas de huchas se alinean y registran ahora con el mes de presupuesto correspondiente.
                                </div>
                            </div>
                        </div>
