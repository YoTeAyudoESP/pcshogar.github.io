            ...
            {lines.map((line, idx) => {
                ...
                if (cleanLine.toLowerCase().startsWith('novedades') && cleanLine.endsWith(':')) {
                    return (
                        <div key={idx} style={{ 
                            ...
                            borderBottom: '1px solid rgba(var(--color-success-rgb), 0.2)',
                            paddingBottom: '6px',
                            marginBottom: '0.4rem',
                            display: 'flex',
                            alignItems: 'center',
                ...
                return (
                    <div key={idx} style={{ 
                        ...
                        <div style={{ flex: 1, fontSize: '0.85rem', lineHeight: '1.45', color: 'rgba(var(--color-rgb-light),0.85)' }}>
                            {title && <span style={{ fontWeight: 700, color: 'var(--text-main)', display: 'block', marginBottom: '2px' }}>{title}</span>}
                            <span>{desc}</span>
                        </div>
                    </div>
                );
            ...
            <div style={{ 
                ...
                <button
                    ...
                    style={{
                        ...
                        gap: '0.5rem',
                        padding: '10px 16px',
                        background: currentView === 'dashboard' ? 'var(--panel-bg-3)' : 'transparent',
                        border: 'none',
                ...
                <button
                    ...
                    style={{
                        ...
                        gap: '0.5rem',
                        padding: '10px 16px',
                        background: currentView === 'settings' ? 'var(--panel-bg-3)' : 'transparent',
                        border: 'none',
                        borderRadius: 'var(--radius-md)',
                        color: currentView === 'settings' ? 'var(--text-main)' : 'var(--text-muted)',
                        cursor: 'pointer',
                        fontSize: '0.9rem',
                        fontWeight: 600
                    }}
                ...
                (() => {
                    ...
                    return (
                        <div 
                            ...
                            style={{
                                background: isSurplus ? 'rgba(var(--color-success-rgb), 0.15)' : 'rgba(244, 63, 94, 0.15)',
                                border: `1px solid ${isSurplus ? 'rgba(var(--color-success-rgb), 0.3)' : 'rgba(244, 63, 94, 0.3)'}`,
                                borderRadius: 'var(--radius-md)',
                                padding: '0.75rem 1rem',
                                marginBottom: '1.5rem',
                                display: 'flex',
                                ...
                                cursor: 'pointer',
                                color: isSurplus ? 'var(--color-primary)' : '#f43f5e',
                                fontWeight: 600,
                                fontSize: '0.9rem'
                            }}
                        >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    ...
                    <div style={{ 
                        ...
                        <button 
                            ...
                            style={{ ...actionButtonStyle, background: 'var(--color-primary)' }}
                        >
                            <PlusCircle size={20} />
                ...
                return (
                    <div className="modal-overlay" onClick={() => setShow30DayReminder(false)}>
                        <div className="modal-container glass-panel" style={{ padding: '2.5rem 2rem', maxWidth: '440px', width: '95%', textAlign: 'center', position: 'relative' }} onClick={e => e.stopPropagation()}>
                            ...
                            <p style={{ fontSize: '0.95rem', lineHeight: '1.6', color: 'rgba(var(--color-rgb-light),0.7)', marginBottom: '2rem' }}>
            ...
            {showChangelog && (
                <div className="modal-overlay" onClick={() => {
                    ...
                    <div className="modal-container glass-panel" style={{ padding: '2.5rem 2rem', maxWidth: '460px', width: '95%', textAlign: 'center', position: 'relative' }} onClick={e => e.stopPropagation()}>
                        ...
                        <p style={{ fontSize: '0.85rem', color: 'rgba(var(--color-rgb-light),0.4)', marginBottom: '1.5rem' }}>
                        ...
                        <div style={{ 
                            ...
                            {changelogEntriesToShow.map((entry, idx) => (
                                <div key={entry.version} style={{
                                    borderBottom: idx < changelogEntriesToShow.length - 1 ? '1px dashed var(--panel-bg-3)' : 'none',
