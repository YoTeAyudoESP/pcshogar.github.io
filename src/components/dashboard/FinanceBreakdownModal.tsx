            ...
            <div className="modal-container glass-panel" style={{ padding: '1.5rem', background: '#12141c', maxWidth: '450px' }} onClick={e => e.stopPropagation()}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                    ...
                    <button 
                        onClick={onClose} 
                        style={{ 
                            background: 'rgba(var(--color-rgb-light), 0.2) !important', 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ 
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', alignItems: 'center' }}>
                            <span style={{ color: 'var(--color-success)', fontWeight: 600 }}>Ingresos Totales</span>
                            <span style={{ color: 'var(--color-success)', fontWeight: 700, fontSize: '1.1rem', whiteSpace: 'nowrap' }}>{formatCurrency(ingresosTotales, false)}</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '0.9rem', color: 'rgba(var(--color-rgb-light),0.6)' }}>
                    ...
                    <div style={{ 
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.75rem', alignItems: 'center' }}>
                            <span style={{ color: 'var(--text-main)', fontWeight: 600 }}>Ahorros y Huchas</span>
                            <span style={{ color: 'var(--text-main)', fontWeight: 700, fontSize: '1.1rem', whiteSpace: 'nowrap' }}>-{formatCurrency(ahorrosYHuchas, false)}</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '0.9rem', color: 'rgba(var(--color-rgb-light),0.6)' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            return (
                                <div style={{ 
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        <span style={{ color: 'var(--text-main)', fontWeight: 600 }}>Deuda Pendiente (Tarjetas)</span>
                                        <span style={{ color: '#f43f5e', fontWeight: 700, fontSize: '1.1rem', whiteSpace: 'nowrap' }}>
                                            {formatCurrency(pendingCardDebt, false)}
                                        </span>
                                    </div>
                                    <div style={{ fontSize: '0.85rem', color: 'rgba(var(--color-rgb-light),0.5)', marginTop: '0.5rem' }}>
                ...
                <div style={{ 
                    ...
                    <span style={{ fontSize: '1.5rem', fontWeight: 900, color: totalDisponible >= 0 ? 'var(--color-success)' : '#f43f5e', whiteSpace: 'nowrap' }}>
