        ...
        <section className="glass-panel" style={{
            ...
            <div style={{ 
                ...
                <div style={{ 
                    ...
                    fontWeight: 900, 
                    color: availableToSpend >= 0 ? 'var(--color-success)' : '#f43f5e',
                    lineHeight: '1.1',
                    textShadow: availableToSpend >= 0 
                        ? '0 0 20px rgba(var(--color-success-rgb), 0.4), 0 0 40px rgba(var(--color-success-rgb), 0.2)' 
                ...
                <button 
                    ...
                    style={{
                        background: 'none',
                        border: 'none',
                        color: 'rgba(var(--color-rgb-light), 0.3)',
                        cursor: 'pointer',
                        padding: '8px',
                        position: 'absolute',
                        right: '0',
            ...
            <div style={{ 
                ...
                <div style={{ textAlign: isMobile ? 'center' : 'left' }}>
                    <div style={{ color: 'rgba(var(--color-rgb-light), 0.5)', fontSize: '0.85rem', marginBottom: '4px' }}>
                        Ingresos (Mes)
                    </div>
                    <div style={{ color: 'var(--color-success)', fontWeight: 800, fontSize: '1.2rem', whiteSpace: 'nowrap' }}>
