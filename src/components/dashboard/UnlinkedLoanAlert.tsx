            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1, minWidth: '280px' }}>
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, color: 'rgba(var(--color-rgb-light), 0.8)', fontSize: '0.85rem', lineHeight: '1.4' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                            ...
                            {unlinkedLoans.length > 1 && (
                                <div>
                                    ...
                                    <select 
                                        style={{ background: 'var(--panel-bg-2)', border: '1px solid var(--panel-bg-3)', borderRadius: '0.75rem', padding: '0.75rem', color: 'var(--text-main)', width: '100%' }}
                            ...
                            <div>
                                <p style={{ fontSize: '0.88rem', color: 'rgba(var(--color-rgb-light), 0.7)', margin: '0 0 1rem 0', lineHeight: '1.5' }}>
                            ...
                            <div>
                                ...
                                <div style={{ position: 'relative', marginBottom: '0.5rem' }}>
                                    <input 
                                        ...
                                        style={{ background: 'var(--panel-bg-2)', border: '1px solid var(--panel-bg-3)', borderRadius: '0.75rem', padding: '0.75rem 0.75rem 0.75rem 2.25rem', color: 'var(--text-main)', width: '100%', boxSizing: 'border-box' }}
                                        value={searchText}
                                ...
                                <select 
                                    style={{ background: 'rgba(25, 27, 34, 0.9)', border: '1px solid var(--panel-bg-3)', borderRadius: '0.75rem', padding: '0.75rem', color: 'var(--text-main)', width: '100%', outline: 'none' }}
                                    value={selectedRecId}
                            ...
                            <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                                <button 
                                    type="button" 
                                    onClick={() => setIsModalOpen(false)}
                                    style={{ flex: 1, padding: '0.85rem', borderRadius: '0.75rem', border: '1px solid var(--panel-bg-3)', background: 'var(--panel-bg-2)', color: 'var(--text-main)', fontWeight: 600, cursor: 'pointer' }}
                                >
                                    Cancelar
                                </button>
                                <button 
                                    ...
                                    style={{
                                        ...
                                        color: !selectedRecId ? 'rgba(var(--color-rgb-light),0.3)' : 'var(--text-main)',
                                        fontWeight: 700,
