    ...
    return (
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-container" style={{ padding: '2rem' }} onClick={e => e.stopPropagation()}>
                ...
                <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-main)', margin: '0 0 1.5rem 0' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    {type === 'puntual' ? (
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <Calendar 
                                    size={18} 
                                    style={{ position: 'absolute', right: '1rem', top: '1.3rem', color: 'rgba(var(--color-rgb-light),0.3)', pointerEvents: 'none' }} 
                                />
                            </div>
                        </div>
                    ) : (
                    ...
                    {type === 'puntual' && !isRefund && (
                        <div style={{ 
                            ...
                            <label style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', color: 'var(--text-main)', fontSize: '1.1rem', fontWeight: 600 }}>
                                <input 
                                    type="checkbox" 
                            ...
                            <p style={{ color: 'rgba(var(--color-rgb-light),0.4)', fontSize: '0.85rem', marginTop: '8px', marginLeft: '32px' }}>
                    ...
                    <button type="submit" disabled={isFundingInvalid || hasNoAccounts} style={{
                        ...
                        color: (isFundingInvalid || hasNoAccounts) ? 'rgba(var(--color-rgb-light),0.3)' : 'var(--text-main)',
                        fontWeight: 700,
                        fontSize: '1.1rem',
