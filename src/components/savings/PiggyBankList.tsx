                ...
                return (
                    ...
                    >
                            ...
                            <div style={{ minWidth: 0, flex: 1 }}>
                                ...
                                {!isMobile && (
                                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                        ...
                                        {linkedIncome && (
                                            <div style={{ fontSize: '0.75rem', color: 'var(--color-success)', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 600 }}>
                        ...
                        <div style={{ 
                            ...
                            justifyContent: 'space-between', 
                            alignItems: 'center',
                            borderTop: isMobile ? '1px solid var(--panel-bg-2)' : 'none',
                            ...
                            <div style={{ display: 'flex', gap: isMobile ? '8px' : '12px', color: 'rgba(var(--color-rgb-light),0.6)', marginLeft: 'auto' }}>
                                <button 
                                    onClick={() => onAddMoney(goal)}
                                    title="Añadir dinero (Ahorrar)"
                                    style={{ background: 'none', border: 'none', color: 'var(--color-success)', cursor: 'pointer', padding: '4px', display: 'flex', alignItems: 'center' }}
                                >
                                ...
                                <button 
                                    ...
                                    title="Eliminar"
                                    style={{ background: 'none', border: 'none', color: 'rgba(var(--color-rgb-light),0.2)', cursor: 'pointer', padding: '4px', display: 'flex', alignItems: 'center' }}
                                >
