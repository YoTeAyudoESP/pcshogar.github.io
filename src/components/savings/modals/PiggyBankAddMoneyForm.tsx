        ...
        <div style={{
            ...
            <form onSubmit={handleSubmit} className="glass-panel" style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
                    <div style={{ padding: '10px', background: 'rgba(var(--color-success-rgb), 0.1)', borderRadius: '12px', color: 'var(--color-success)' }}>
                        <PlusCircle size={24} />
                    </div>
                    <div>
                ...
                <div style={{ marginBottom: '1rem', fontSize: '0.95rem', color: 'rgba(var(--color-rgb-light),0.7)', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <div>
                    <label style={{ display: 'block', marginBottom: '0.5rem', color: 'rgba(var(--color-rgb-light),0.5)', fontSize: '0.85rem' }}>Importe a Ahorrar ({getCurrencySymbol()})</label>
