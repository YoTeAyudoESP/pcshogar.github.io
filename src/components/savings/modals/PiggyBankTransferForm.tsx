        ...
        <div style={{
            ...
            <form onSubmit={handleSubmit} className="glass-panel" style={{ 
                ...
                <div style={{ display: 'grid', gap: '1.5rem' }}>
                    <div>
                        <label style={{ display: 'block', marginBottom: '0.5rem', color: 'rgba(var(--color-rgb-light),0.5)', fontSize: '0.85rem' }}>Hucha de Origen</label>
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '0.5rem', color: 'rgba(var(--color-rgb-light),0.5)', fontSize: '0.85rem' }}>Hucha de Destino</label>
                    ...
                    <div>
                        <label style={{ display: 'block', marginBottom: '0.5rem', color: 'rgba(var(--color-rgb-light),0.5)', fontSize: '0.85rem' }}>Importe a Traspasar ({getCurrencySymbol()})</label>
                        <input type="number" step="0.01" style={inputStyle} value={amount} onChange={e => setAmount(e.target.value)} placeholder="0.00" required />
                    </div>
                </div>

                <div style={{ background: 'rgba(99, 102, 241, 0.05)', padding: '1rem', borderRadius: '12px', marginTop: '1rem', fontSize: '0.85rem', color: 'rgba(var(--color-rgb-light),0.6)', border: '1px solid rgba(99, 102, 241, 0.1)' }}>
