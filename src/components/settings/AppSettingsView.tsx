...
const AppSettingsView: React.FC = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                        ...
                        {APP_THEMES.map(t => (
                            <button
                                ...
                                style={{
                                    ...
                                    background: settings.theme === t.id ? 'rgba(99, 102, 241, 0.1)' : 'var(--panel-bg-2)',
                                    color: 'var(--text-main)',
                                    cursor: 'pointer',
                                    display: 'flex',
                                    flexDirection: 'column',
                ...
                <section style={groupStyle}>
                    ...
                    {activeProfile?.pinHash ? (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--color-success)', fontSize: '0.95rem', fontWeight: 600 }}>
                                <Check size={18} />
                            ...
                            <div style={{ 
                                ...
                                <div style={{ 
                                    ...
                                    background: activeProfile?.biometricEnabled ? 'var(--color-primary)' : 'var(--panel-bg-3)',
                                    cursor: 'pointer', position: 'relative', transition: '0.3s',
                                    flexShrink: 0
                                }} onClick={() => setProfileBiometric(!activeProfile?.biometricEnabled)}>
                                    <div style={{ 
                                        width: '18px', height: '18px', borderRadius: '50%', background: 'var(--text-main)',
            ...
            <section style={groupStyle}>
                <h3 style={zoneTitleStyle}><Database size={20} color="var(--color-success)" /> Bases de Datos y Seguridad</h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            <div style={{ 
                                width: '40px', height: '24px', borderRadius: '12px', 
                                background: settings.sync.enabled ? 'var(--color-primary)' : 'var(--panel-bg-3)',
                                cursor: 'pointer', position: 'relative', transition: '0.3s'
                        ...
                        {[
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '0.75rem',
                                    border: '1px solid',
                                    borderColor: settings.sync.type === type.id ? 'var(--color-primary)' : 'var(--panel-bg-3)',
                                    background: settings.sync.type === type.id ? 'rgba(99, 102, 241, 0.1)' : 'transparent',
                                    color: settings.sync.type === type.id ? 'var(--text-main)' : 'rgba(var(--color-rgb-light),0.4)',
                                    display: 'flex',
                    ...
                    {settings.sync.type === 'smb' && (
                        <div style={{ textAlign: 'center', padding: '1rem', border: '1px dashed var(--panel-bg-3)', borderRadius: '0.75rem' }}>
                    ...
                    {settings.sync.type === 'dropbox' && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <div style={{ 
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    {!dropboxConnected && (
                                        <button 
                                            ...
                                            style={{ background: '#0061FF', color: 'var(--text-main)', border: 'none', padding: '0.5rem 1.25rem', borderRadius: '0.5rem', fontSize: '0.85rem', cursor: 'pointer', fontWeight: 700 }}
                                        >
                                            Conectar Cuenta
                                        </button>
                                    )}
                                ...
                                {dropboxConnected && (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', borderTop: '1px solid var(--panel-bg-2)', paddingTop: '1.25rem' }}>
                                        {/* Path configuration */}
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                                <div style={{ 
                                                    ...
                                                    <FileJson size={16} color="rgba(var(--color-rgb-light),0.3)" />
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    {!settings.sync.googledriveToken && (
                                        <button 
                                            ...
                                            style={{ background: '#34A853', color: 'var(--text-main)', border: 'none', padding: '0.5rem 1.25rem', borderRadius: '0.5rem', fontSize: '0.85rem', cursor: 'pointer', fontWeight: 700 }}
                                        >
                                            Conectar Cuenta
                                        </button>
                                    )}
                    ...
                    <div style={{ 
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <div style={{ textAlign: 'left' }}>
                                ...
                                <div style={{ fontSize: '0.75rem', color: 'rgba(var(--color-rgb-light), 0.5)' }}>Avisar de los gastos fijos previstos para mañana al abrir la aplicación</div>
                            </div>
                        </div>
                        <div style={{ 
                            width: '40px', height: '24px', borderRadius: '12px', 
                            background: settings.notifyNextDayPayments ? 'var(--color-primary)' : 'var(--panel-bg-3)',
                            cursor: 'pointer', position: 'relative', transition: '0.3s',
                            flexShrink: 0
                    ...
                    <div style={{ 
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <div style={{ textAlign: 'left' }}>
                                ...
                                <div style={{ fontSize: '0.75rem', color: 'rgba(var(--color-rgb-light), 0.5)' }}>Versión actual instalada: <strong>v{versionInfo.version}</strong></div>
                            </div>
                        </div>

                        {downloading ? (
                            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem', color: 'rgba(var(--color-rgb-light),0.7)' }}>
                            ...
                            <button
                                ...
                                onMouseEnter={e => { if (!checking) e.currentTarget.style.background = 'var(--panel-bg-3)'; }}
                                onMouseLeave={e => { if (!checking) e.currentTarget.style.background = 'var(--panel-bg-2)'; }}
                            >
