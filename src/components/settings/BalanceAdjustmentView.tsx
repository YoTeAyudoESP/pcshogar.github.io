...
const BalanceAdjustmentView: React.FC = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            {/* 1. Header with Form */}
            <div className="glass-panel" style={{ padding: '1.5rem', background: 'rgba(var(--color-rgb-light), 0.03)' }}>
            ...
            <div>
                ...
                <div className="glass-panel" style={{ padding: 0, overflow: 'hidden' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                        <thead style={{ background: 'var(--panel-bg-1)' }}>
                            <tr>
                        ...
                        <tbody>
                            {historyClosings.length === 0 ? (
                                ...
                                historyClosings.map(c => (
                                    <tr key={c.id} style={{ borderTop: '1px solid var(--panel-bg-2)' }}>
                                        ...
                                        <td style={{ padding: '1rem', textAlign: 'center' }}>
                                            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
                                                ...
                                                <button 
                                                    ...
                                                    style={{ background: 'none', border: 'none', color: 'rgba(var(--color-rgb-light),0.3)', cursor: 'pointer' }}
                                                >
                                                    <EyeOff size={16} />
                                                </button>
                                                <button 
                            ...
                            <tbody>
                                {activeRemnants.length === 0 ? (
                                    ...
                                    activeRemnants.map(rem => (
                                        <tr key={rem.id} style={{ borderTop: '1px solid var(--panel-bg-2)' }}>
                                            ...
                                            <td style={{ padding: '0.75rem', textAlign: 'center', color: 'rgba(var(--color-rgb-light),0.4)' }}>Vinculado</td>
                        ...
                        {ignoredClosings.length === 0 ? (
                            ...
                            ignoredClosings.map(c => (
                                <div key={c.id} className="glass-panel" style={{ 
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                        <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'rgba(var(--color-rgb-light),0.2)' }} />
                ...
                <div className="modal-overlay" onClick={() => setEditingClosing(null)}>
                    <div className="modal-container glass-panel" style={{ padding: '2rem', maxWidth: '400px' }} onClick={e => e.stopPropagation()}>
                        ...
                        <div style={{ marginBottom: '1.5rem' }}>
                            <label style={{ display: 'block', color: 'rgba(var(--color-rgb-light),0.5)', fontSize: '0.85rem', marginBottom: '0.5rem' }}>Importe (€)</label>
                            <input 
                                type="number" 
                                step="0.01" 
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            ...
                            <button 
                                ...
                                style={{ 
                                    flex: 1, background: 'none', border: '1px solid var(--panel-bg-3)', 
