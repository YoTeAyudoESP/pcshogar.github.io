                        ...
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            <button 
                                ...
                                style={{
                                    ...
                                    border: '1px solid',
                                    borderColor: type === 'expense' ? '#ff4757' : 'var(--panel-bg-3)',
                            ...
                            <button 
                                ...
                                style={{
                                    ...
                                    borderRadius: '0.75rem',
                                    border: '1px solid',
                                    borderColor: type === 'income' ? '#2ed573' : 'var(--panel-bg-3)',
                            ...
                            {CATEGORY_ICONS.map(({ name: n, Icon }) => (
                                <button
                                    ...
                                    style={{
                                        padding: '0.75rem',
                                        borderRadius: '0.5rem',
                                        background: icon === n ? 'var(--panel-bg-3)' : 'none',
                                        border: 'none',
                                        color: icon === n ? 'var(--text-main)' : 'rgba(var(--color-rgb-light),0.3)',
                                        cursor: 'pointer',
                                        display: 'flex',
                                        alignItems: 'center',
