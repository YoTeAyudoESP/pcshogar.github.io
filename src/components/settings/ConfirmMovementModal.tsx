            ...
            <div className="modal-container glass-panel" style={{ padding: '2rem', maxWidth: '450px' }} onClick={e => e.stopPropagation()}>
                ...
                {isDuplicateIncome && (
                    <div style={{
                        ...
                        <p style={{ fontSize: '0.8rem', color: 'rgba(var(--color-rgb-light),0.6)', margin: 0, lineHeight: 1.4 }}>
                            Este ingreso ya fue registrado en el periodo actual ({currentRealPeriod}). ¿Cómo deseas contabilizar este cobro?
                        </p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.85rem', color: 'var(--text-main)', marginTop: '0.25rem' }}>
