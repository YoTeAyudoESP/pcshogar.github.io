...
const EconomyManagementModal: React.FC<EconomyManagementModalProps> = ({ isOpen, onClose }) => {
    ...
    const getEconomyIcon = (ecoName: string) => {
        ...
        if (lower.includes('vecino') || lower.includes('comunid') || lower.includes('edifici')) {
            return <Building2 size={16} color="var(--color-success)" />;
        }
        ...
        <div style={overlayStyle}>
            <div style={modalStyle}>
                ...
                <div style={contentStyle}>
                                        ...
                                        <>
                                            ...
                                            <div style={{ display: 'flex', gap: '8px', width: '100%' }}>
                                                ...
                                                <button
                                                    ...
                                                    style={{
                                                        flex: 1,
                                                        background: 'rgba(var(--color-rgb-light),0.04)',
                    ...
                    <div style={{ ...sectionStyle, borderTop: '1px solid var(--panel-border)', paddingTop: '20px' }}>
                        ...
                        <form onSubmit={handleAdd} style={formStyle}>
                            ...
                            {creationMode === 'import_json' && (
                                <div style={inputGroupStyle}>
                                    ...
                                    />
                                    {importFileName && (
                                        <div style={{ fontSize: '12.5px', color: 'var(--color-success)', marginTop: '2px', fontWeight: '500' }}>
                            ...
                            {syncType !== 'local' && !isCheckingCloud && cloudFileExists && creationMode === 'link_existing' && (
                                <div style={{ ...infoContainerStyle, border: '1px solid rgba(var(--color-success-rgb), 0.3)', background: 'rgba(var(--color-success-rgb), 0.08)' }}>
                                ...
                                return (
                                    <div style={inputGroupStyle}>
                                        ...
                                        <div style={{
                                            ...
                                            padding: '10px 14px',
                                            borderRadius: '10px',
                                            background: hasToken ? 'rgba(var(--color-success-rgb), 0.08)' : 'rgba(var(--color-rgb-light),0.03)',
                                            border: `1px solid ${hasToken ? 'rgba(var(--color-success-rgb),0.2)' : 'rgba(var(--color-rgb-light),0.08)'}`
                                        }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                <Cloud size={16} color={hasToken ? 'var(--color-success)' : '#94a3b8'} />
                                                <span style={{ fontSize: '13px', color: hasToken ? 'var(--color-success)' : '#94a3b8', fontWeight: 600 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    background: 'rgba(var(--color-rgb-light),0.06)',
                                    ...
                                    <div style={inputGroupStyle}>
                                        ...
                                        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.4rem' }}>
                                            ...
                                            <button
                                                ...
                                                disabled={!hasToken}
                                                style={{
                                                    background: hasToken ? 'var(--panel-bg-3)' : 'var(--panel-bg-2)',
                                                    border: '1px solid var(--panel-bg-3)',
                                                    color: hasToken ? 'var(--text-main)' : 'rgba(var(--color-rgb-light), 0.3)',
                                                    padding: '0 12px',
                                                    borderRadius: '8px',
                                                    fontSize: '0.85rem',
                                                    fontWeight: 600,
                                    ...
                                    {ownedEconomies.map(eco => {
                                        ...
                                        return (
                                            <div 
                                                key={eco.id} 
                                                style={{ 
                                                    background: 'rgba(var(--color-rgb-light), 0.01)', 
