            ...
            <div className="modal-container glass-panel" style={{ padding: '2rem' }} onClick={e => e.stopPropagation()}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    <div style={{ 
                        ...
                        background: isDeficit ? 'rgba(239, 68, 68, 0.1)' : 'rgba(var(--color-success-rgb), 0.1)',
                    ...
                    <div style={{ 
                        ...
                        background: Math.abs(remainingAmount) <= 0.01 ? 'rgba(var(--color-success-rgb), 0.2)' : 'rgba(245, 158, 11, 0.2)',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '2rem' }}>
                    {/* Next Month Row */}
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(var(--color-rgb-light),0.03)', padding: '0.75rem 1rem', borderRadius: '12px' }}>
                    ...
                    {/* Savings Goals Rows */}
                    {savings.map(s => (
                        <div key={s.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(var(--color-rgb-light),0.03)', padding: '0.75rem 1rem', borderRadius: '12px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    ...
                    <button 
                        onClick={onClose}
                        style={{ 
                            width: '100%', background: 'none', border: '1px solid var(--panel-bg-3)', 
